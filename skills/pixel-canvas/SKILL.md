...
### Rules for 1px Outlines

1. **Top edge** = horizontal line of pixels
2. **Bottom edge** = horizontal line of pixels  
3. **Left/right edges** = ONLY the edge pixel on each row (skip middle!)
4. **Never 2+ pixels thick**
5. **Interior stays EMPTY** - other agents fill it
